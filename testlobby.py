...
pygame.display.set_caption("who tryna hang with wang")
...
char1_img = pygame.transform.scale(char1_img, (50,65))
char2_img = pygame.image.load("char2.png").convert_alpha()
char2_img = pygame.transform.scale(char2_img, (50,65))
...
def reset_objects():
    global grass_list, platform_list, trampoline_list
    grass_list = []
    platform_list = []
    trampoline_list = []
...
while running:
    ...
    # Toolbar background
    pygame.draw.rect(screen, (100,100,150), (SCREEN_WIDTH-TOOLBAR_WIDTH,0,TOOLBAR_WIDTH,SCREEN_HEIGHT))
